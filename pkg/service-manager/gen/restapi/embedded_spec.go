      ...
      "get": {
        ...
        "responses": {
          "200": {
            ...
            "schema": {
              "$ref": "#/definitions/getServiceClassesOKBody"
            }
          },
          "default": {
      ...
      "get": {
        ...
        "responses": {
          "200": {
            "description": "successful operation",
            "schema": {
              "$ref": "#/definitions/getServiceInstancesOKBody"
            }
          },
          "400": {
  ...
  "definitions": {
    ...
    "ServiceClass": {
      ...
      "properties": {
        ...
        "tags": {
          "$ref": "#/definitions/serviceClassTags"
        }
      }
    },
    "ServiceInstance": {
      ...
      "properties": {
        ...
        "tags": {
          "$ref": "#/definitions/serviceInstanceTags"
        }
      }
    },
    "ServicePlan": {
