...
type GetServiceInstancesOK struct {
	...
	/*
	  In: Body
	*/
	Payload models.GetServiceInstancesOKBody `json:"body,omitempty"`
}
...
func (o *GetServiceInstancesOK) WithPayload(payload models.GetServiceInstancesOKBody) *GetServiceInstancesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get service instances o k response
func (o *GetServiceInstancesOK) SetPayload(payload models.GetServiceInstancesOKBody) {
	o.Payload = payload
}
...
func (o *GetServiceInstancesOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	payload := o.Payload
	if payload == nil {
		payload = make(models.GetServiceInstancesOKBody, 0, 50)
	}
