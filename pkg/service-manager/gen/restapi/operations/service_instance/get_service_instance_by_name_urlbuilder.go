...
func (o *GetServiceInstanceByNameURL) WithBasePath(bp string) *GetServiceInstanceByNameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetServiceInstanceByNameURL) Build() (*url.URL, error) {
	...
	if serviceInstanceName != "" {
		...
		return nil, errors.New("ServiceInstanceName is required on GetServiceInstanceByNameURL")
	}
...
func (o *GetServiceInstanceByNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServiceInstanceByNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServiceInstanceByNameURL")
	}
