...
// Default API manager HTTP client.
...
// NewHTTPClient creates a new API manager HTTP client.
func NewHTTPClient(formats strfmt.Registry) *APIManager {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new API manager HTTP client,
...
// APIManager is a client for API manager
...
func (c *APIManager) SetTransport(transport runtime.ClientTransport) {
