...
// IstioHandlers configures the istio backed API gateway
type IstioHandlers struct {
	knClient sharedclientset.Interface
}

// NewIstioHandlers create a new IstioHandlers instance
...
// AddAPI adds a new istio API route
...
// GetAPI gets an istio API route
...
// UpdateAPI updates an istio API route
...
// DeleteAPI deletes an istio API route
