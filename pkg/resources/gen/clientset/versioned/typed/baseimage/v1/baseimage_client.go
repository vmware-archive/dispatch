...
import (
	...
	"github.com/vmware/dispatch/pkg/resources/gen/clientset/versioned/scheme"
...
// ResourcesV1Client is used to interact with features provided by the resources.dispatchframework.io group.
type ResourcesV1Client struct {
	restClient rest.Interface
}

func (c *ResourcesV1Client) BaseImages(namespace string) BaseImageInterface {
	return newBaseImages(c, namespace)
}
