...
import (
	resourcesv1 "github.com/vmware/dispatch/pkg/resources/gen/clientset/versioned/typed/baseimage/v1"
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.resourcesV1, err = resourcesv1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.resourcesV1 = resourcesv1.NewForConfigOrDie(c)
