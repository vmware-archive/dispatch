...
// UpdateFunctionByNameParams contains all the bound params for the update function by name operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateFunctionByName
...
func (o *UpdateFunctionByNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *UpdateFunctionByNameParams) bindFunctionName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *UpdateFunctionByNameParams) validateFunctionName(formats strfmt.Registry) error {
