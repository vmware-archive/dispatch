...
// Default application manager HTTP client.
...
const (
	...
	// found in Meta (info) section of spec file
	DefaultBasePath string = "/v1/application"
)

// DefaultSchemes are the default schemes found in Meta (info) section of spec file
var DefaultSchemes = []string{"http", "https"}

// NewHTTPClient creates a new application manager HTTP client.
func NewHTTPClient(formats strfmt.Registry) *ApplicationManager {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new application manager HTTP client,
...
// ApplicationManager is a client for application manager
...
func (c *ApplicationManager) SetTransport(transport runtime.ClientTransport) {
