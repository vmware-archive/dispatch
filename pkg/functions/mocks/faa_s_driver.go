...
// Create provides a mock function with given fields: ctx, f, exec
func (_m *FaaSDriver) Create(ctx context.Context, f *functions.Function, exec *functions.Exec) error {
	ret := _m.Called(ctx, f, exec)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *functions.Function, *functions.Exec) error); ok {
		r0 = rf(ctx, f, exec)
	} else {
		r0 = ret.Error(0)
	}
