...
import (
	...
	"github.com/vmware/dispatch/pkg/functions/gen/restapi/operations/runner"
	"github.com/vmware/dispatch/pkg/functions/gen/restapi/operations/store"
)

//go:generate swagger generate server --target ../pkg/functions/gen --name Functions --spec ../swagger/functions.yaml --model-package v1 --skip-models --exclude-main

func configureFlags(api *operations.FunctionsAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.FunctionsAPI) http.Handler {
