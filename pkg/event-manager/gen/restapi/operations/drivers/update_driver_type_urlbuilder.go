...
func (o *UpdateDriverTypeURL) Build() (*url.URL, error) {
	...
	if driverTypeName != "" {
		...
		return nil, errors.New("DriverTypeName is required on UpdateDriverTypeURL")
	}
...
func (o *UpdateDriverTypeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateDriverTypeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateDriverTypeURL")
	}
