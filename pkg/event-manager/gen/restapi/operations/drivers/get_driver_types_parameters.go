...
// GetDriverTypesParams contains all the bound params for the get driver types operation
...
func (o *GetDriverTypesParams) bindXDispatchOrg(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetDriverTypesParams) bindXDispatchProject(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetDriverTypesParams()
		return nil
	}
...
func (o *GetDriverTypesParams) validateXDispatchProject(formats strfmt.Registry) error {
...
func (o *GetDriverTypesParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
