...
// GetDriverTypeParams contains all the bound params for the get driver type operation
...
func (o *GetDriverTypeParams) bindXDispatchOrg(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetDriverTypeParams) bindXDispatchProject(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetDriverTypeParams()
		return nil
	}
...
func (o *GetDriverTypeParams) validateXDispatchProject(formats strfmt.Registry) error {
...
func (o *GetDriverTypeParams) bindDriverTypeName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetDriverTypeParams) validateDriverTypeName(formats strfmt.Registry) error {
