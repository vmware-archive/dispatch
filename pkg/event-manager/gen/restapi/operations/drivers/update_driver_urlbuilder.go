...
func (o *UpdateDriverURL) Build() (*url.URL, error) {
	...
	if driverName != "" {
		...
		return nil, errors.New("DriverName is required on UpdateDriverURL")
	}
...
func (o *UpdateDriverURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateDriverURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateDriverURL")
	}
