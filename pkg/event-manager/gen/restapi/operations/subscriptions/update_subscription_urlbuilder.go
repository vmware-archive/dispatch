...
func (o *UpdateSubscriptionURL) Build() (*url.URL, error) {
	...
	if subscriptionName != "" {
		...
		return nil, errors.New("SubscriptionName is required on UpdateSubscriptionURL")
	}
...
func (o *UpdateSubscriptionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateSubscriptionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateSubscriptionURL")
	}
