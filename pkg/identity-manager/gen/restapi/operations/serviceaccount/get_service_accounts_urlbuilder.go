...
func (o *GetServiceAccountsURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/iam/serviceaccount"
...
func (o *GetServiceAccountsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServiceAccountsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServiceAccountsURL")
	}
