...
//go:generate swagger generate server --target ../root/go/src/gitlab.eng.vmware.com/serverless/serverless/pkg/identity-manager/gen --name IdentityManager --spec ../root/go/src/gitlab.eng.vmware.com/serverless/serverless/swagger/identity-manager.yaml --exclude-main
