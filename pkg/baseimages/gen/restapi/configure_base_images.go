...
//go:generate swagger generate server --target ../pkg/baseimages/gen --name BaseImages --spec ../swagger/baseimages.yaml --model-package v1 --skip-models --exclude-main

func configureFlags(api *operations.BaseImagesAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.BaseImagesAPI) http.Handler {
