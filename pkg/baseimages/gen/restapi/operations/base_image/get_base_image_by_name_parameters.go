...
func (o *GetBaseImageByNameParams) validateXDispatchOrg(formats strfmt.Registry) error {
...
// bindBaseImageName binds and validates parameter BaseImageName from path.
...
// validateBaseImageName carries on validations for parameter BaseImageName
