...
func (o *DeleteBaseImageByNameParams) bindXDispatchOrg(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteBaseImageByNameParams()
		return nil
	}
...
func (o *DeleteBaseImageByNameParams) validateXDispatchOrg(formats strfmt.Registry) error {
...
func (o *DeleteBaseImageByNameParams) bindXDispatchProject(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteBaseImageByNameParams) validateXDispatchProject(formats strfmt.Registry) error {
