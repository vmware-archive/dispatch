...
// AddEndpointParams contains all the bound params for the add endpoint operation
// typically these are obtained from a http.Request
//
// swagger:parameters addEndpoint
...
//
// To ensure default values, the struct must have been initialized with NewAddEndpointParams() beforehand.
func (o *AddEndpointParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AddEndpointParams) bindXDispatchOrg(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewAddEndpointParams()
		return nil
	}
