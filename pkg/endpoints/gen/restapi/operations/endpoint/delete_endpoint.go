...
type DeleteEndpointHandlerFunc func(DeleteEndpointParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteEndpointHandlerFunc) Handle(params DeleteEndpointParams, principal interface{}) middleware.Responder {
...
type DeleteEndpointHandler interface {
	Handle(DeleteEndpointParams, interface{}) middleware.Responder
}
