...
type GetBaseImageByNameHandlerFunc func(GetBaseImageByNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetBaseImageByNameHandlerFunc) Handle(params GetBaseImageByNameParams) middleware.Responder {
	return fn(params)
}
...
type GetBaseImageByNameHandler interface {
	Handle(GetBaseImageByNameParams) middleware.Responder
}
