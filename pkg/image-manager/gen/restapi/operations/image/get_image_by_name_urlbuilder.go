...
func (o *GetImageByNameURL) Build() (*url.URL, error) {
	...
	if imageName != "" {
		...
		return nil, errors.New("ImageName is required on GetImageByNameURL")
	}
...
func (o *GetImageByNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetImageByNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetImageByNameURL")
	}
