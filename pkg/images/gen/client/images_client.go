...
// NewHTTPClient creates a new images HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Images {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new images HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Images {
...
// New creates a new images client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Images {
	// ensure nullable parameters have default
	if formats == nil {
