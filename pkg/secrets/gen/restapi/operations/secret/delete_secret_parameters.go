...
func (o *DeleteSecretParams) bindXDispatchOrg(rawData []string, hasKey bool, formats strfmt.Registry) error {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteSecretParams()
		return nil
	}
...
func (o *DeleteSecretParams) validateXDispatchOrg(formats strfmt.Registry) error {
...
func (o *DeleteSecretParams) bindXDispatchProject(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteSecretParams) validateXDispatchProject(formats strfmt.Registry) error {
