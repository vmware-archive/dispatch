...
<title>Repositioning | Dispatch Serverless Framework</title>
...
<link rel="canonical" href="http://localhost:4000/dispatch/assets/node_modules/tether/docs/1-Overview/2-repositioning.html" />
<meta property="og:url" content="http://localhost:4000/dispatch/assets/node_modules/tether/docs/1-Overview/2-repositioning.html" />
<meta property="og:site_name" content="Dispatch Serverless Framework" />
<script type="application/ld+json">
{"name":null,"description":"Dispatch is a framework for deploying and managing serverless style applications.","author":null,"@type":"WebPage","url":"http://localhost:4000/dispatch/assets/node_modules/tether/docs/1-Overview/2-repositioning.html","publisher":null,"image":null,"headline":"Repositioning","dateModified":null,"datePublished":null,"sameAs":null,"mainEntityOfPage":null,"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<p>Tethers will be automatically repositioned when the page is resized, and when any element containing the Tether is scrolled.
If the element moves for some other reason (e.g. with JavaScript), Tether won’t know to reposition the element.</p>

<h4 id="manually-repositioning">Manually Repositioning</h4>

<p>The simplest way to reposition every Tether on the page is to call <code class="highlighter-rouge">Tether.position()</code>.  It will efficiently reposition every
Tether in a single repaint, making it more efficient than manually repositioning many Tethers individually.</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">Tether</span><span class="p">.</span><span class="nx">position</span><span class="p">()</span>
</code></pre></div></div>

<h4 id="repositioning-a-single-tether">Repositioning a Single Tether</h4>

<p>If you have many Tethers on screen, it may be more efficient to just reposition the tether that needs it.  You can do this
by calling the <code class="highlighter-rouge">.position</code> method on the Tether instance:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">tether</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Tether</span><span class="p">({</span> <span class="p">...</span> <span class="p">})</span>

<span class="c1">// Later:</span>
<span class="nx">tether</span><span class="p">.</span><span class="nx">position</span><span class="p">()</span>
</code></pre></div></div>

<h4 id="tethering-hidden-elements">Tethering Hidden Elements</h4>

<p>If you are creating a tether involving elements which are <code class="highlighter-rouge">display: none</code>, or not actually in the DOM, 
your Tether may not be able to position itself properly.  One way around this is to
ensure that a position call happens after all layouts have finished:</p>

<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">myElement</span><span class="p">.</span><span class="nx">style</span><span class="p">.</span><span class="nx">display</span> <span class="o">=</span> <span class="s1">'block'</span>

<span class="nx">tether</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">Tether</span><span class="p">({</span> <span class="p">...</span> <span class="p">})</span>
...
<p>In general however, you shouldn’t have any trouble if both the element and the target are visible and in the DOM when you
create the Tether.  If that is not the case, create the Tether disabled (option <code class="highlighter-rouge">enabled</code>: <code class="highlighter-rouge">false</code>), and enable it when
the elements are ready.</p>
