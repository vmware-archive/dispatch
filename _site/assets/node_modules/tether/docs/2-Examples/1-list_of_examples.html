...
<title>Examples | Dispatch Serverless Framework</title>
...
<link rel="canonical" href="http://localhost:4000/dispatch/assets/node_modules/tether/docs/2-Examples/1-list_of_examples.html" />
<meta property="og:url" content="http://localhost:4000/dispatch/assets/node_modules/tether/docs/2-Examples/1-list_of_examples.html" />
<meta property="og:site_name" content="Dispatch Serverless Framework" />
<script type="application/ld+json">
{"name":null,"description":"Dispatch is a framework for deploying and managing serverless style applications.","author":null,"@type":"WebPage","url":"http://localhost:4000/dispatch/assets/node_modules/tether/docs/2-Examples/1-list_of_examples.html","publisher":null,"image":null,"headline":"Examples","dateModified":null,"datePublished":null,"sameAs":null,"mainEntityOfPage":null,"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
...
<ul>
  <li><a href="../../examples/simple">simple</a>: A simple example to get you started</li>
  <li><a href="../../examples/out-of-bounds">out-of-bounds</a>: How to hide the element when it would
otherwise be offscreen</li>
  <li><a href="../../examples/pin">pin</a>: How to pin the element so it never goes offscreen</li>
  <li><a href="../../examples/enable-disable">enable-disable</a>: How to enable and disable the Tether
in JavaScript</li>
</ul>
...
<ul>
  <li><a href="../../examples/content-visible">content-visible</a>: Demonstrates using the <code class="highlighter-rouge">'visible'</code>
<code class="highlighter-rouge">targetModifier</code> to align an element with the visible portion of another.</li>
  <li><a href="../../examples/dolls">dolls</a>: A performance test to show several dozen elements,
each tethered to the previous.  Try dragging the top left tether.</li>
  <li><a href="../../examples/element-scroll">element-scroll</a>: Demonstrates using the <code class="highlighter-rouge">'scroll-handle'</code>
<code class="highlighter-rouge">targetModifier</code> to align an element with the scrollbar of an element.</li>
  <li><a href="../../examples/scroll">scroll</a>: Demonstrates using the <code class="highlighter-rouge">'scroll-handle'</code> <code class="highlighter-rouge">targetModifier</code>
to align an element with the body’s scroll handle.</li>
  <li><a href="../../examples/viewport">viewport</a>: Demonstrates aligning an element with the
viewport by using the <code class="highlighter-rouge">'visible'</code> <code class="highlighter-rouge">targetModifier</code> when tethered to the body.</li>
</ul>
