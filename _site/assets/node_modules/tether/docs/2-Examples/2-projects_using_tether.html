...
<title>Projects Using Tether | Dispatch Serverless Framework</title>
<meta property="og:title" content="Projects Using Tether" />
...
<link rel="canonical" href="http://localhost:4000/dispatch/assets/node_modules/tether/docs/2-Examples/2-projects_using_tether.html" />
<meta property="og:url" content="http://localhost:4000/dispatch/assets/node_modules/tether/docs/2-Examples/2-projects_using_tether.html" />
<meta property="og:site_name" content="Dispatch Serverless Framework" />
<script type="application/ld+json">
{"name":null,"description":"Dispatch is a framework for deploying and managing serverless style applications.","author":null,"@type":"WebPage","url":"http://localhost:4000/dispatch/assets/node_modules/tether/docs/2-Examples/2-projects_using_tether.html","publisher":null,"image":null,"headline":"Projects Using Tether","dateModified":null,"datePublished":null,"sameAs":null,"mainEntityOfPage":null,"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
    ...
    <div class="header-backdrop"></div>
            ...
            <documentation class="content-container"><router-outlet></router-outlet>
                <div class="content-area">
                    ...
                    <h2 id="projects-using-tether">Projects Using Tether</h2>

<p>Here at HubSpot we have built a bunch of libraries on top of Tether,
both because we wanted Tether-performance, and because we saw opportunities
to improve on what was available in the client-side ecosystem.</p>

<h3 id="select"><a href="http://github.hubspot.com/select/docs/welcome">Select</a></h3>

<p>Select is a replacement for native browser select elements that is fully stylable.</p>

<h3 id="shepherd"><a href="http://github.hubspot.com/shepherd/docs/welcome">Shepherd</a></h3>

<p>Shepherd is a library for making tours of your app to help onboard users and show off
new features.</p>

<h3 id="tooltip"><a href="http://github.hubspot.com/tooltip/docs/welcome">Tooltip</a></h3>

<p>A simple, easy-to-use implementation of tooltips that works well.</p>

<h3 id="drop"><a href="http://github.hubspot.com/drop/docs/welcome">Drop</a></h3>

<p>Where Tether does general-purpose positioning, Drop assumes that you are interested
in making something which pops up next to something the user clicks or hovers on.</p>

<p>If you’re building something that fits that pattern, Drop can make things a little easier.</p>

<h3 id="blueprint"><a href="http://blueprintjs.com/">Blueprint</a></h3>

<p>A React UI toolkit for the web.</p>

<h3 id="bootstrap-4"><a href="http://getbootstrap.com/">Bootstrap 4</a></h3>

<p>Tooltip and popovers from Bootstrap 4 are positioned using Tether</p>

<h3 id="ember-tether"><a href="https://github.com/yapplabs/ember-tether">Ember Tether</a></h3>

<p>An Ember.js-friendly interface for tether.</p>

<h3 id="react-datepicker"><a href="https://github.com/Hacker0x01/react-datepicker">React Datepicker</a></h3>

<p>A simple and reusable datepicker component for React</p>

<h3 id="your-project-here">Your Project Here</h3>

<p>If you have a cool open-source library built on Tether, PR this doc.</p>
