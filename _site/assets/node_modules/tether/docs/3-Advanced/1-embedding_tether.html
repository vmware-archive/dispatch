...
<title>Embedding Tether | Dispatch Serverless Framework</title>
<meta property="og:title" content="Embedding Tether" />
...
<link rel="canonical" href="http://localhost:4000/dispatch/assets/node_modules/tether/docs/3-Advanced/1-embedding_tether.html" />
<meta property="og:url" content="http://localhost:4000/dispatch/assets/node_modules/tether/docs/3-Advanced/1-embedding_tether.html" />
<meta property="og:site_name" content="Dispatch Serverless Framework" />
<script type="application/ld+json">
{"name":null,"description":"Dispatch is a framework for deploying and managing serverless style applications.","author":null,"@type":"WebPage","url":"http://localhost:4000/dispatch/assets/node_modules/tether/docs/3-Advanced/1-embedding_tether.html","publisher":null,"image":null,"headline":"Embedding Tether","dateModified":null,"datePublished":null,"sameAs":null,"mainEntityOfPage":null,"@context":"http://schema.org"}</script>
<!-- End Jekyll SEO tag -->
    ...
    <div class="header-backdrop"></div>
            ...
            <documentation class="content-container"><router-outlet></router-outlet>
                <div class="content-area">
                    ...
                    <h2 id="embedding-tether">Embedding Tether</h2>

<p>Tether is designed to be embeddable in other libraries.</p>

<p>There is one thing you should think about doing to create an embedded Tether:</p>

<ul>
  <li>Set the <code class="highlighter-rouge">classPrefix</code> of the tethers you create.  That prefix will replace <code class="highlighter-rouge">'tether'</code> in
all of the classes.  You can also disable classes you don’t intend on using with the <code class="highlighter-rouge">classes</code>
option.</li>
</ul>
