...
* image
dispatch create base-image python3 vmware/dispatch-python3-base:0.0.2-dev1 --language python3
...
Below is an example of the context passed to the function:
    {
        ...
        "serviceBindings": {
            "azure-pg": {
                "database": "tsfuw5flxw",
                "host": "cc41126d-4bc5-46b6-80c9-74d528779c81.postgres.database.azure.com",
                "password": "*******",
                "port": "5432",
                "sslRequired": "true",
                "tags": "[\"postgresql\"]",
                "uri": "postgresql://luryo9enzo%40cc41126d-4bc5-46b6-80c9-74d528779c81:*******@cc41126d-4bc5-46b6-80c9-74d528779c81.postgres.database.azure.com:5432/tsfuw5flxw?\u0026sslmode=require",
                "username": "luryo9enzo@cc41126d-4bc5-46b6-80c9-74d528779c81"
            }
        }
    }
