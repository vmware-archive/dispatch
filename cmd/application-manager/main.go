...
import (
	...
	"github.com/vmware/dispatch/pkg/application-manager"
...
func main() {
	...
	tracer, tracingCloser, err := utils.CreateTracer("ApplicationManager", applicationmanager.ApplicationManagerFlags.Tracer)
	if err != nil {
